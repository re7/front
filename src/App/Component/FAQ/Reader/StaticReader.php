    ...
    static private function buildCategories()
    {
        $categories = [
            ...
            new Category('Le lexique', 'lexique', [
                ...
                new Question('Raid', 'A la fin d\'un stream, certains streamers aiment raider un autre streamer. C\'est à dire lui envoyer tous leurs viewers avec un même message envoyé sur le chat'),
            ]),
        ];
